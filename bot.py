...
# │  BOT TOKEN  add karo.   ││
# └──────────────────────────────────────────────────────────────┘
BOT_TOKEN_HARDCODED = "8645440063:AAGNUI1Dd7IA786pPjghMj2EflN6g8Th9BE"   # ← ADD BOT TOKEN
TOKEN = (
...
try:
    OWNER_ID = int(os.environ.get("OWNER_ID", "921287475"))
...
BRAND       = "ℙ𝕣𝕖𝕞𝕚𝕦𝕞 ℍ𝕠𝕤𝕥𝕚𝕟𝕘 𝔹𝕠𝕥"
BRAND_VER   = "v2.1"
BRAND_TAG   = f"{BRAND} {BRAND_VER}"
SUPPORT_USR = "@SkAnish143"
UPDATE_CH   = "https://t.me/+k6G1oyRrdQU3NmM1"
...
PLAN_LIMITS: Dict[str, Dict[str, Any]] = {
    ...
    "starter":    {"name": "Starter",    "max_bots": 10,   "ram": 256,  "auto_restart": True,  "price": 99,   "days": 50},
    "basic":      {"name": "Basic",      "max_bots": 50,  "ram": 512,  "auto_restart": True,  "price": 199,  "days": 100},
    "pro":        {"name": "Pro",        "max_bots": 99,  "ram": 2048, "auto_restart": True,  "price": 499,  "days": 200},
    "enterprise": {"name": "Enterprise", "max_bots": 999,  "ram": 4096, "auto_restart": True,  "price": 999,  "days": 300},
    "lifetime":   {"name": "Lifetime",   "max_bots": 99999, "ram": 8192, "auto_restart": True,  "price": 1999, "days": 36500},
}

PAYMENT_METHODS: Dict[str, Dict[str, Any]] = {
    "Phonepe":   {"name": "Phonepe",       "number": "anish1432@fam",         "type": "Send Money",       "tag": "[P]"},
    "Googlepay":   {"name": "Googlepay",       "number": "anish1432@fam",         "type": "Send Money",       "tag": "[G]"},
    "Paytm":  {"name": "Paytm",      "number": "anish1432@fam",         "type": "Send Money",       "tag": "[P]"},
    "Fampay":    {"name": "Fampay",        "number": "anish1432@fam",         "type": "Send Money",       "tag": "[F]"},
...
REQUIRED_GROUPS = [
    {"id": -1002027547140, "link": "https://t.me/+k6G1oyRrdQU3NmM1", "name": "Group 1"},
    {"id": -1002612551886, "link": "https://t.me/+BfaPqVmYAVQ4NzQ1",     "name": "Group 2"},
]
...
_HELP_PAGES = {
    "main": {
        "title": "📚 Help Centre",
        "text": (
            "Welcome to <b>ℙ𝕣𝕖𝕞𝕚𝕦𝕞 ℍ𝕠𝕤𝕥𝕚𝕟𝕘 𝔹𝕠𝕥</b>\n\n"
            "<b>Quick Start</b>\n"
